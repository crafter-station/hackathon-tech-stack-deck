    ...
    <div className={compact ? "space-y-4" : "space-y-4 lg:space-y-5"}>
      ...
      {slide.final ? (
        <div
          className={
            compact
              ? "max-w-5xl rounded-xl border border-white/10 bg-white/[0.04] p-3 text-sm font-medium leading-6 tracking-[-0.02em] text-zinc-200 shadow-2xl shadow-black/20"
              : "max-w-4xl rounded-2xl border border-white/10 bg-white/[0.04] p-3 text-base font-medium leading-7 tracking-[-0.03em] text-zinc-200 shadow-2xl shadow-black/20 sm:p-4 sm:text-lg sm:leading-7"
          }
        >
          {slide.final}
        </div>
